...
def train_transformer_main(data_path: str, out_dir: str, args):
    ...
    if best_strategy_state is None or best_strategy_cfg is None or best_strategy_val_stats is None:
        raise RuntimeError("best_strategy_state/best_strategy_cfg is None. Training did not produce a valid strategy checkpoint.")
    ...
    save_scaler_stats(save_dir, mean, std, feats)
