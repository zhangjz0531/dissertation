...
def train_grouped_model(
    ...
    for epoch in range(1, args.max_epochs + 1):
        ...
        best_filter, best_filter_stats, constraints_ok, _ = choose_best_execution_filters(
...
def main():
    ...
    parser.add_argument("--confidence_margin_grid", type=str, default="0.0,0.005,0.01,0.02")
    parser.add_argument("--use_align_filter_grid", type=str, default="true,false")
    parser.add_argument("--vix_z_max_grid", type=str, default="1.0,1.5,2.0,None")
    parser.add_argument("--credit_quantile_grid", type=str, default="0.7,0.8,None")
