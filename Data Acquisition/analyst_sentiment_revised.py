...
class SentimentAnalyst:
    """
    Fear/sentiment proxy based on VIX.
    This is acceptable for a dissertation prototype, but in writing you should call it
    a sentiment proxy rather than a full social-media sentiment engine.
    """
    ...
    def run(self, start: str, end: str) -> pd.DataFrame:
        ...
        # High VIX => risk-off => lower sentiment score.
