...
class TechnicalFeatureBuilder:
    def __init__(self):
        self.name = "Technical Feature Builder"
    ...
    def _calc_tech_indicators(self, group: pd.DataFrame) -> pd.DataFrame:
        ...
        fill_map = {"return_1d":0.0,"log_return_1d":0.0,"return_5d":0.0,"return_21d":0.0,"volatility_20d":0.0,"rsi_14":50.0,"macd":0.0,"macd_signal":0.0,"macd_hist":0.0,"macd_hist_pct":0.0,"ma10_ratio":0.0,"ma20_ratio":0.0,"ma60_ratio":0.0,"atr_14":0.0,"atr_pct":0.0,"hl_spread":0.0,"volume_z_20":0.0}
...
TechnicalAnalyst = TechnicalFeatureBuilder
